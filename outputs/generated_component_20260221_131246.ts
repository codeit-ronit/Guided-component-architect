...
@Component({
  ...
  template: `
    <div class="card" style="background: #f8fafc; backdrop-filter: blur(10px); border-radius: 8px; padding: 24px; border: 1px solid #6366f1">
      ...
      <form>
        ...
        <button type="submit" style="background: #6366f1; color: #1e293b; padding: 12px 24px; border: none; border-radius: 8px; font-family: Inter; cursor: pointer">Login</button>
      </form>
    </div>
  `,
  styles: [`
